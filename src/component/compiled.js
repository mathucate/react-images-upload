...
var ReactImageUploadComponent = function (_React$Component) {
  ...
  _createClass(ReactImageUploadComponent, [{
    ...
    */
    ...
    key: "moveImage",
    value: function moveImage(dragIndex, hoverIndex) {
      var dragPicture = this.state.pictures[dragIndex];
      var dragFile = this.state.files[dragIndex];
      var reorderedPictures = (0, _immutabilityHelper2.default)(this.state.pictures, {
        $splice: [[dragIndex, 1], [hoverIndex, 0, dragPicture]]
      });
      var reorderedFiles = (0, _immutabilityHelper2.default)(this.state.files, {
        $splice: [[dragIndex, 1], [hoverIndex, 0, dragFile]]
      });
      this.setState({ pictures: reorderedPictures, files: reorderedFiles });
    }
      ...
      return this.state.pictures.map(function (picture, index) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_PreviewPicture2.default, {
            ...
            moveImage: function moveImage(a, b) {
              return _this5.moveImage(a, b);
            }
          })
        );
      });
